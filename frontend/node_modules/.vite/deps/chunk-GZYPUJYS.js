...
import {
  ...
  serializeStyles,
  styled
} from "./chunk-WMIRIBHQ.js";
import {
  require_react_is
} from "./chunk-G3HNFEPJ.js";
import {
  require_jsx_runtime
...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = React14.useMemo(() => storageManager?.({
    key: modeStorageKey,
    storageWindow
  }), [storageManager, modeStorageKey, storageWindow]);
  const lightStorage = React14.useMemo(() => storageManager?.({
    key: `${colorSchemeStorageKey}-light`,
    storageWindow
  }), [storageManager, colorSchemeStorageKey, storageWindow]);
  const darkStorage = React14.useMemo(() => storageManager?.({
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GZYPUJYS.js.map
